...
TEST(Vanuskin_Dmitry_Base64DecoderTests, DecodeLowLevelBytes) {
  ...
  auto expectResult =
      std::string({127, 126, 125, 127, 123, 8, 5, 13, 0, 1, 127});
...
TEST(Vanuskin_Dmitry_Base64DecoderTests, DecodeEncodedFirstTestCodeAsMessage) {
  auto encodedMessage =
      "VEVTVChWYW51c2tpbl9EbWl0cnlfQmFzZTY0RW5jb"
  ...
  auto expectResult =
      R"(TEST(Vanuskin_Dmitry_Base64EncoderTests, EncodeEmptyMessage) {
    auto message = "";
    auto expectResult = "";
...
TEST(Vanuskin_Dmitry_Base64DecoderTests, DecodeMessageWithInvalidSymbols) {
...
TEST(Vanuskin_Dmitry_Base64DecoderTests, DecodeMessageWithOnlySpeciicSymbols) {
  auto encodedMessage = "====";
