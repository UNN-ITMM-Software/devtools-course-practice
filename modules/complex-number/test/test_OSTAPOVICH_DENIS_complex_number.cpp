...
typedef testing::TestWithParam<std::tuple<double, double>> 
    Ostapovich_Denis_ComplexNumberTest_Parameterized_2;

typedef testing::TestWithParam<std::tuple<double, double, double, double>>
    Ostapovich_Denis_ComplexNumberTest_Parameterized_4;

TEST_P(Ostapovich_Denis_ComplexNumberTest_Parameterized_2, Equality_Operator_Not_Zero) {
...
TEST_P(Ostapovich_Denis_ComplexNumberTest_Parameterized_4, No_Throw_On_Addition) {
...
INSTANTIATE_TEST_CASE_P(/**/, Ostapovich_Denis_ComplexNumberTest_Parameterized_2,
    testing::Values(
...
INSTANTIATE_TEST_CASE_P(/**/, Ostapovich_Denis_ComplexNumberTest_Parameterized_4,
    testing::Values(
