...
TEST_P(Mukhin_Ivan_parametric_test_2, can_mult_complex_numbers) {
  ...
  ComplexNumber b(second_pair.first, second_pair.second);
  ComplexNumber c = a * b;
  double Re = (first_pair.first * second_pair.first -
               first_pair.second * second_pair.second);
  double Im = (first_pair.first * second_pair.second +
...
INSTANTIATE_TEST_CASE_P(
    Mukhin_Ivan_tests_cases, Mukhin_Ivan_parametric_test_1,
    testing::Values(make_pair(2.0, 3.0), make_pair(0.0, 0.0),
                    make_pair(-2.0, 3.0), make_pair(2.12132, 10.213),
                    make_pair(-12.0, 83.0), make_pair(-120.12, 718.05)));

INSTANTIATE_TEST_CASE_P(
    Mukhin_Ivan_tests_cases, Mukhin_Ivan_parametric_test_2,
    testing::Values(
