...
TEST(Vanushkin_Dmitry_ComplexNumberTest, InvertComplexNumber) {
  ...
  auto expectDivision =
      ComplexNumber(real / (real * real + imaginary * imaginary),
...
TEST(Vanushkin_Dmitry_ComplexNumberTest,
  ...
  auto first =
      ComplexNumber(3.000000000000000000000003, 15.0000000000000000000000006);
  auto second =
      ComplexNumber(3.0000000000000000000000091, 15.0000000000000000000000008);
