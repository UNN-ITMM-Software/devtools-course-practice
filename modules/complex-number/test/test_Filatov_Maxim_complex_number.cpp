...
INSTANTIATE_TEST_CASE_P(TestComplexNumbersWithFirstPairValues,
                        Filatov_Maxim_ComplexNumberTestWithFirstPairValues,
                        ::testing::Values(std::make_pair(INT_MIN, INT_MIN),
                                          std::make_pair(-1.0, -1.0),
                                          std::make_pair(.0, .0),
                                          std::make_pair(1.0, 1.0),
                                          std::make_pair(INT_MAX, INT_MAX)));

INSTANTIATE_TEST_CASE_P(TestComplexNumbersWithSecondPairValues,
                        Filatov_Maxim_ComplexNumberTestWithSecondPairValues,
                        ::testing::Values(std::make_pair(INT_MAX, INT_MIN),
                                          std::make_pair(-1.4, -1.5),
                                          std::make_pair(.4, .5),
                                          std::make_pair(1.4, 1.5),
                                          std::make_pair(INT_MAX, INT_MIN)));

INSTANTIATE_TEST_CASE_P(TestComplexNumbersWithFirstTupleValues,
                        Filatov_Maxim_ComplexNumberTestWithFirstTupleValues,
                        ::testing::Values(std::make_tuple(.1, .2, 2.22, 2.0),
                                          std::make_tuple(1.11, 1.0, 2.22, 2.0),
                                          std::make_tuple(.1, .2, .3, .4),
                                          std::make_tuple(-1.0, -1.0, 1.0, 1.0),
                                          std::make_tuple(-1.0, -1.0, .1, .2)));

INSTANTIATE_TEST_CASE_P(TestComplexNumbersWithSecondTupleValues,
                        Filatov_Maxim_ComplexNumberTestWithSecondTupleValues,
                        ::testing::Values(std::make_tuple(.1, .2, .0, .0),
...
TEST_P(Filatov_Maxim_ComplexNumberTestWithFirstTupleValues,
  ...
  EXPECT_DOUBLE_EQ((re1 * re2 + im1 * im2) / (re2 * re2 + im2 * im2),
                   z.getRe());
  EXPECT_DOUBLE_EQ((im1 * re2 - re1 * im2) / (re2 * re2 + im2 * im2),
                   z.getIm());
}
