...
double QuadraticSolver::getA() const { return a; }

double QuadraticSolver::getB() const { return b; }

double QuadraticSolver::getC() const { return c; }

double QuadraticSolver::getDiscriminant() const { return b * b - 4 * a * c; }
