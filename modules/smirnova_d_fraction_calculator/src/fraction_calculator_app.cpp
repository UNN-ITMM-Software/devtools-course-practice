...
bool FractionCalculatorApplication::Validate(int argc, char *argv[]) {
  ...
  if (argc == 1) {
    ...
    Help(argv[0]);
    return false;
  } else if (std::strcmp(argv[5], "+") != 0 && std::strcmp(argv[5], "-") != 0 &&
             std::strcmp(argv[5], "*") != 0 && std::strcmp(argv[5], "/") != 0) {
...
std::string FractionCalculatorApplication::FractionCalculation(int argc,
                                                               char *argv[]) {
