...
int FractionCalculator::GetNum() const { return num; }

void FractionCalculator::SetNum(const int numerator) { num = numerator; }

int FractionCalculator::GetDen() const { return den; }
