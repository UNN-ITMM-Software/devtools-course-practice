...
std::vector<std::string> DequeApp::runApp(int argc, const char** argv) {
...
std::vector<std::string> DequeApp::parse(int argc, const char** argv) {
...
void DequeApp::push_back(std::vector<std::string>& output, std::string elem) {
  deque.push_back(elem);
}
void DequeApp::push_front(std::vector<std::string>& output, std::string elem) {
