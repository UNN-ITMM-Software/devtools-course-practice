...
#include "include/increasingCont.h"


TEST(Kulaev_Zhenya_increasing_test, Test_small) {
  const size_t m = 4;
  const size_t n = 4;
  const int new_min = 0;
...
TEST(Kulaev_Zhenya_increasing_test, Test_fourth) {
  const size_t m = 5;
  const size_t n = 4;
  const int new_min = 0;
  const int new_max = 255;
...
TEST(Kulaev_Zhenya_increasing_test, Test_1all) {
  const size_t m = 4;
  const size_t n = 4;
  const int new_min = 0;
  const int new_max = 255;
...
TEST(Kulaev_Zhenya_increasing_test, Test_3ll) {
  const size_t m = 4;
  const size_t n = 4;
  const int new_min = 0;
  const int new_max = 255;
