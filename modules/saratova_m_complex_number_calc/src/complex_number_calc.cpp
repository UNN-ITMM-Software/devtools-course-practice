...
ComplexCalculator ComplexCalculator::add(const ComplexCalculator& other) const {
    double result_real = real + other.real;
    double result_imaginary = imaginary + other.imaginary;
    return ComplexCalculator(result_real, result_imaginary);
}

ComplexCalculator ComplexCalculator::subtract(const ComplexCalculator& other) const {
    double result_real = real - other.real;
    double result_imaginary = imaginary - other.imaginary;
    return ComplexCalculator(result_real, result_imaginary);
}

ComplexCalculator ComplexCalculator::multiply(const ComplexCalculator& other) const {
...
ComplexCalculator ComplexCalculator::divide(const ComplexCalculator& other) const {
