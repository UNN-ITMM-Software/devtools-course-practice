...
ComplexCalculator ComplexCalculator::subtract
...
ComplexCalculator ComplexCalculator::multiply
                            (const ComplexCalculator& other) const {
...
ComplexCalculator ComplexCalculator::divide
                            (const ComplexCalculator& other) const {
    ...
    double result_real = (real * other.real + imaginary * other.imaginary)
    / denominator;
    double result_imaginary = (imaginary * other.real - real * other.imaginary)
    / denominator;
    return ComplexCalculator(result_real, result_imaginary);
}
