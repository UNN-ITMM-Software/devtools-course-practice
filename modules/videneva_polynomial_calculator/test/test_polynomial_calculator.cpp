...
TEST(polynomial_calculator, removes_the_polynomial_correctly) {
...
TEST(polynomial_calculator, can_Check_Number_Of_Arguments_correctly) {
  std::vector<double> a;
  a.push_back(1.1);
  a.push_back(1.2);
  a.push_back(1.3);
...
TEST(polynomial_calculator, The_polynomials_are_defined_as_unequal) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  a.push_back(1.3);
...
TEST(polynomial_calculator, The_polynomials_are_defined_as_unequal_no_throw) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  a.push_back(1.3);
...
TEST(polynomial_calculator, The_polynomials_are_defined_as_unequal_no_throw_2) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  a.push_back(1.3);
...
TEST(polynomial_calculator, The_polynomials_are_defined_as_unequal_corr) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  a.push_back(1.3);
...
TEST(polynomial_calculator, The_polynomials_are_defined_as_unequal_correct_2) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(1.0);
  a.push_back(1.3);
...
TEST(polynomial_calculator, can_add_polynomials_different_sizes) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  std::vector<double> b;
...
TEST(polynomial_calculator, can_add_polynomials_different_sizes_2) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  std::vector<double> b;
...
TEST(polynomial_calculator, can_add_polynomials_different_sizes_correct) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  std::vector<double> b;
...
TEST(polynomial_calculator, can_sub_polynomials_different_sizes) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  std::vector<double> b;
...
TEST(polynomial_calculator, can_sub_polynomials_different_sizes_2) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  std::vector<double> b;
...
TEST(polynomial_calculator, can_sub_polynomials_different_sizes_correct) {
  std::vector<double> a;
  a.push_back(5.1);
  a.push_back(12.0);
  std::vector<double> b;
...
TEST(polynomial_calculator, can_mult_polynomials_different_sizes) {
  std::vector<double> a;
  a.push_back(5);
  a.push_back(12);
  std::vector<double> b;
...
TEST(polynomial_calculator, can_mult_polynomials_different_sizes_2) {
  std::vector<double> a;
  a.push_back(5);
  a.push_back(12);
  std::vector<double> b;
...
TEST(polynomial_calculator, can_mult_polynomials_different_sizes_correct) {
  std::vector<double> a;
  a.push_back(2);
  a.push_back(1);
  a.push_back(0);
...
TEST(polynomial_calculator, can_mult_polynomials_different_sizes_correct_2) {
  std::vector<double> a;
  a.push_back(4);
  a.push_back(0);
  a.push_back(0);
...
TEST(polynomial_calculator, can_sum_empty_polynom_and_constant) {
  polynomial_calculator P;
  ASSERT_NO_THROW(P + 2);
  std::vector<double> b;
  b.push_back(2);
...
TEST(polynomial_calculator, can_sum_not_empty_polynom_and_constant) {
  std::vector<double> a;
  a.push_back(2);
  a.push_back(1);
  a.push_back(5);
...
TEST(polynomial_calculator, can_min_not_empty_polynom_and_constant) {
  std::vector<double> a;
  a.push_back(2);
  a.push_back(1);
  a.push_back(5);
...
TEST(polynomial_calculator, can_mult_not_empty_polynom_and_constant) {
  std::vector<double> a;
  a.push_back(2);
  a.push_back(1);
  a.push_back(5);
