...
TEST(Vinokurov_I_Figure_Surface, Non_Valid_Arguements_Parallelepiped) {
    ...
    ASSERT_THROW(figureSurfaceCalc.fnCalculateSurfaceParallelepiped(a, b, c), std::invalid_argument);
}
...
TEST(Vinokurov_I_Figure_Surface, Non_Valid_Arguements_Cylinder_Side) {
    ...
    ASSERT_THROW(figureSurfaceCalc.fnCalculateSurfaceCylinderSide(r, h), std::invalid_argument);
}
...
TEST(Vinokurov_I_Figure_Surface, Non_Valid_Arguements_Cylinder_Full) {
    ...
    ASSERT_THROW(figureSurfaceCalc.fnCalculateSurfaceCylinderFull(r, h), std::invalid_argument);
}
...
TEST(Vinokurov_I_Figure_Surface, Non_Valid_Arguements_Cone_Side) {
    ...
    ASSERT_THROW(figureSurfaceCalc.fnCalculateSurfaceConeSide(r, l), std::invalid_argument);
}
...
TEST(Vinokurov_I_Figure_Surface, Non_Valid_Arguements_Cone_Full) {
    ...
    ASSERT_THROW(figureSurfaceCalc.fnCalculateSurfaceConeFull(r, l), std::invalid_argument);
}
...
TEST(Vinokurov_I_Figure_Surface, Non_Valid_Arguements_Sphere) {
    ...
    ASSERT_THROW(figureSurfaceCalc.fnCalculateSurfaceSphere(r), std::invalid_argument);
}
...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Parallelepiped) {
    ...
    ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceParallelepiped(r) - resApproximate, 0.001)
}
...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Cylinder_Side) {
    ...
    ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceCylinderSide(r) - resApproximate, 0.001)
}
...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Cylinder_Full) {
    ...
    ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceCylinderFull(r) - resApproximate, 0.001)
}
...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Cone_Side) {
    ...
    ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceConeSide(r) - resApproximate, 0.001)
}
...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Cone_Full) {
    ...
    ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceConeFull(r) - resApproximate, 0.001)
}
...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Sphere) {
    ...
    ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceSphere(r) - resApproximate, 0.001)
}
