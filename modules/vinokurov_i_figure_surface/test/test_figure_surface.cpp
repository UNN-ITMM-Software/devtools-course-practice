...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Parallelepiped) {
  ...
  ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceParallelepiped(a, b, c) -
                resApproximate,
            0.001);
}
...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Cone_Side) {
  ...
  ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceConeSide(r, l) - resApproximate,
            0.001);
}
...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Cone_Full) {
  ...
  ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceConeFull(r, l) - resApproximate,
            0.001);
}
...
TEST(Vinokurov_I_Figure_Surface, Valid_Arguements_Sphere) {
  ...
  ASSERT_LE(figureSurfaceCalc.fnCalculateSurfaceSphere(r) - resApproximate,
            0.001);
}
